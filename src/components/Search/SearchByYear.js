...
import coursesData from '@/lib/mbbs_college_list.json'; // Import the JSON data containing course and year info
  ...
  return (
    <div className="relative">
      <Autosuggest
        ...
        theme={{
          container: 'relative',
          suggestionsContainer: 'absolute z-10 w-full shadow-lg border border-gray-200 mt-1',
