import Blogphoto from "../../assets/blogImage3.webp";
      ...
      <div className="container flex my-10 mx-auto max-sm:flex-col max-sm:my-0 max-sm:mx-auto max-sm:px-4 sm:flex-col  md:flex-row justify-between mt-14 pt-4 min-h-screen">
        <div className="container max-sm:w-full main w-4/6">
          ...
          <div className="content">
            <p className="my-9">
            The recent settlement between the US Federal Trade Commission (FTC) and a data broker, formerly known as X-Mode and now rebranded as Outlogic, has been touted as a “historic” privacy win. However, the sad truth emerges as the settlement focuses on stopping the sale of people’s “sensitive location data.” While politicians and some media celebrate the outcome, it reveals a systemic issue where companies can sidestep scrutiny by doing the bare minimum, highlighting the insufficient protections for Americans.
            </p>
            <p className="my-9">
            The FTC’s victory, portrayed as a major privacy win, demands attention for all the wrong reasons. The order targets what the FTC terms “sensitive location data,” a misleading term encompassing any data extensively tracking an individual’s physical presence. The pervasive collection of such data poses a severe threat, exposing political, religious, and personal affiliations. Despite the potential harm, the FTC’s authority is limited to a standard of “notice and choice,” allowing corporations to track Americans relentlessly with minimal legal constraints.
            </p>
            <p className="my-9 text-#8A90A2">
            In the larger context, the Outlogic case exposes the superficial nature of privacy regulations and the challenges consumers face in seeking recourse. The current legal landscape, exemplified by the American Data Privacy and Protection Act of 2022, provides limited safeguards, with exemptions for activities similar to Outlogic’s. The Fourth Amendment Is Not For Sale Act emerges as a potential game-changer, aiming to curb government practices of buying location data from such companies, setting the stage for a crucial debate over US privacy laws.

In essence, while the FTC’s actions against Outlogic may be deemed historic, the true significance lies in the flaws it exposes within the regulatory framework, leaving Americans with inadequate protection against pervasive surveillance practices.
            </p>
          </div>
